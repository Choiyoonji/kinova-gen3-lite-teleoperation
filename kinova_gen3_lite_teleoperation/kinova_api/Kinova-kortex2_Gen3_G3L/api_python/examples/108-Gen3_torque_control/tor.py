        ...
        while not self.kill_the_thread:
            ...
            if (t_now - t_cyclic) >= t_sample:
                ...
                for i in range(self.actuator_count):
                    cmd_pos = self.target_position[i]
                ...
                try:
                    self.base_feedback = self.base_cyclic.Refresh(self.base_command, 0, self.sendOption)
                    self.current_position = [self.base_feedback.actuators[i].position for i in range(self.actuator_count)]
                except:
            ...
            # --
                ...
                self.target_position[0] = self.current_position[0] + 0.01
            # Stats Print
